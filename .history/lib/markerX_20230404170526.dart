...
class _MarkerLayerXState extends State<MarkerLayerX> {
  ...
  void _onPositionChanged() {
    zoomNow = Provider.of<MarkerProvider>(context, listen: false).mapZoom;
  ...
  Widget build(BuildContext context) {
    ...
    print('zoomnow $zoomNow  currentZoon $currentZoom');
    // final newZoom = map.zoom;
    if (zoomNow != currentZoom) {
      visibleMarkers = _getVisibleMarkers();
    }
