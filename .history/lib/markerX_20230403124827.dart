...
class MarkerLayerX extends StatelessWidget {
  ...
  List<MarkerX> _getVisibleMarkers(FlutterMapState map) {
    ...
    for (final marker in markers) {
      ...
      cached['rightPortion'] ??=
          CustomPoint<num>(marker.width - marker.anchor.left, 0);
      cached['leftPortion'] ??= CustomPoint<num>(marker.anchor.left, 0);
      cached['bottomPortion'] ??=
          CustomPoint<num>(0, marker.height - marker.anchor.top);
      cached['topPortion'] ??= CustomPoint<num>(0, marker.anchor.top);
