...
class MarkerLayerX extends StatelessWidget {
  ...
  List<MarkerX> _getVisibleMarkers(FlutterMapState map) {
    ...
    for (final marker in markers) {
      ...
      cached['leftPortion'] ??= marker.anchor.left as CustomPoint<num>;
      cached['bottomPortion'] ??=
          (marker.height - marker.anchor.top) as CustomPoint<num>;
      cached['topPortion'] ??= marker.anchor.top as CustomPoint<num>;
