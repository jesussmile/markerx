...
class _MarkerLayerXState extends State<MarkerLayerX> {
  ...
  void putMarkers(LatLngBounds bounds, List<MarkerX> markers) async {
    markerQuadtree = MarkerQuadtree(bounds, 1000); // adjust capacity as needed
  ...
  Widget build(BuildContext context) {
    ...
    if (newBound != markerQuadtree.bounds) {
      markerQuadtree =
          MarkerQuadtree(newBound!, 1000); // adjust capacity as needed
