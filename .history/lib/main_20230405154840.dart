...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String selectedAsset = 'assets/Waypoints_short.json';
  ...
  Future<void> loadWayPointsMarkers() async {
    ...
    String assetPath = 'assets/Waypoints_short.json';
    if (selectedAsset == "assets/Waypoints.json") {
      assetPath = 'assets/Waypoints.json';
      ...
      appBar: AppBar(
        ...
        actions: [
          Row(
            children: [
              const Text(
                'Select longer or shorter marker -> ',
