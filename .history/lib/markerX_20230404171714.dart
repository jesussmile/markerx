...
class _MarkerLayerXState extends State<MarkerLayerX> {
  ...
  void _initializeState() {
    print('calling _initializeState');
  ...
  void didChangeDependencies() {
    print('calling _didChangeDependencies');
    super.didChangeDependencies();
    _initializeState();
  }

  void _onPositionChanged() {
    print('calling _onpoisitionChaged');
    final newZoom = Provider.of<MarkerProvider>(context, listen: false).mapZoom;
  ...
  List<MarkerX> _getVisibleMarkers() {
    print('_calling _GetVisibleMarkers');
