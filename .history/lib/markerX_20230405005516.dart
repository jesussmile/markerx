...
class _MarkerLayerXState extends State<MarkerLayerX> {
  ...
  List<MarkerX> _getVisibleMarkersX() {
    final visibleMarkers = <MarkerX>[];
    final quadtree = Quadtree<MarkerX>(Bounds(
      map.project(currentBound.northWest),
      map.project(currentBound.southEast),
    ));
    ...
    quadtree
        .query(Bounds(
      map.pixelBounds.bottomLeft,
      map.pixelBounds.topRight,
    ))
        .forEach((marker) {
