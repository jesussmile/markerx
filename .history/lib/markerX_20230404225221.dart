...
class _MarkerLayerXState extends State<MarkerLayerX> {
  ...
  Widget build(BuildContext context) {
    ...
    if (newZoom != currentZoom) {
      ...
      currentZoom = newZoom;
      visibleMarkers = _getVisibleMarkers();
      markerWidgetsCache.clear();
    }
    if (newZoom == currentZoom && markerWidgetsCache.isNotEmpty) {
      // if zoom hasn't changed and there are cached markers, use them
      return Stack(
    ...
    markerWidgetsCache = markerWidgets;
    return Stack(
